...
if __name__ == "__main__":
    ...
    p5 = multiprocessing.Process(target=kafka_utils.kafka_producer_circulate, args=(hosts, topic_name))
    p6 = multiprocessing.Process(target=kafka_utils.kafka_producer_circulate, args=(hosts, topic_name))
    p7 = multiprocessing.Process(target=kafka_utils.kafka_producer_circulate, args=(hosts, topic_name))
    p0.start()
    p1.start()
    p2.start()
    p3.start()
